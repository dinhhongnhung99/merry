            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="sorting_bar d-flex flex-md-row flex-column align-items-md-center justify-content-md-start">
                        <div class="results">Tổng <span>{{count($productsOfCategories->products)}}</span> sản phẩm</div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="product_grid">
                        @php
                            $products = $productsOfCategories->products
                        @endphp
                            ...
                            <div class="product">
                                ...
                                <div class="product_content">
                                    <div class="product_title">
                                        <a href="{{route('home.page.product',[$valueProductsOfCategories->slug, $valueProductsOfCategories->id])}}">
                                            {{$valueProductsOfCategories->name}}
                                        </a>
                                    </div>
                                    <div class="product_price">{{number_format($valueProductsOfCategories->price)}} đ</div>
                                </div>
                            </div>
                        @endforeach
