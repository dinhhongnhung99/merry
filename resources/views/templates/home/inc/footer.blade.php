        ...
        <div class="row">
            <div class="col">
                <div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
                    <div class="footer_logo"><a href="{{$urlHome}}/#">THE MERRY</a></div>
                    <div class="copyright ml-auto mr-auto"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by ĐINH HỒNG NHUNG
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></div>
                    <div class="footer_social ml-lg-auto">
                        <ul>
                            <li><a href="{{$urlHome}}/#"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
                            <li><a href="{{$urlHome}}/#"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                            <li><a href="{{$urlHome}}/#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            <li><a href="{{$urlHome}}/#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
